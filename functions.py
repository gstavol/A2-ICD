...
def scrapping(codes):
    ...
    for y in range(len(codes)):
        ...
        if page.status_code < 300:
            ...
            nome = limpeza.noneformat(h2_elements.find('a'))
            ano = limpeza.limpa_ano(limpeza.noneformat(h2_elements.find('span')))
            ...
            genres = limpeza.limpa_genero(limpeza.noneformat(soup.find('span', {'class':'genres'}))).split(',')
